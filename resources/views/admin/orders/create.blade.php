    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('shipment_company') ? 'is-invalid' : '' }}" name="shipment_company" id="shipment_company">
                    ...
                    @foreach(App\Models\Order::SHIPMENT_COMPANY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('shipment_company', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order_code') ? 'is-invalid' : '' }}" type="text" name="order_code" id="order_code" value="{{ old('order_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('chargeable') ? 'is-invalid' : '' }}" type="text" name="chargeable" id="chargeable" value="{{ old('chargeable', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pieces') ? 'is-invalid' : '' }}" type="number" name="pieces" id="pieces" value="{{ old('pieces', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cash_on_delivery') ? 'is-invalid' : '' }}" type="number" name="cash_on_delivery" id="cash_on_delivery" value="{{ old('cash_on_delivery', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('custom_value') ? 'is-invalid' : '' }}" type="number" name="custom_value" id="custom_value" value="{{ old('custom_value', '') }}" step="0.01">
